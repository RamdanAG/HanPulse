...
import 'package:message/views/register_view.dart';
                  ...
                  SignInForm(
                    ...
                    login: () async{
                      if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
                        final response = await authVM.login(emailController.text, passwordController.text);
                        AwesomeDialog(
                          context: context,
...
class SignInForm extends StatelessWidget {
  const SignInForm({super.key, required this.email, required this.password, required this.login});
    ...
    return Form(
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          ElevatedButton(
            onPressed: authVM.isLoading ? null : login,
