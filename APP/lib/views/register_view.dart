            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  ProfilePic(imageUploadBtnPress: picked, image: profilePath?.path,),
                  // const SizedBox(height: 16),
                  ...
                  SignUpForm(
                    ...
                    register: () async{
                      if(nameController.text.isNotEmpty && emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
                        final response = await authVM.register(nameController.text, emailController.text, passwordController.text, profilePath?.path);
                        AwesomeDialog(
                          context: context,
...
class SignUpForm extends StatelessWidget {
  const SignUpForm({super.key, required this.name, required this.email, required this.password, required this.register});
    ...
    return Form(
      child: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: authVM.isLoading ? null : register,
      ...
      child: Stack(
        ...
        children: [
          ClipRRect(
            ...
            child: image != null
            ? Image.file(File(image!), fit: BoxFit.cover,width: 80, height: 80, errorBuilder: (context, error, stackTrace) => Icon(Icons.person, size: 80,),)
